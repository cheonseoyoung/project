		...
		<form action="<c:url value='pd_insert'/>" method="post" enctype="multipart/form-data">
			<table class="table table-borderless">
				<tbody>
					...
					<tr>
						<td>제조회사</td>
						<td><input type="text" class="form-control form-control-sm" id="pCompany" name="pCompany"/></td>
					</tr>
					<tr>
						<td>상품이미지</td>
						<td><input type="file" class="form-control form-control-sm" id="pImage" name="pImage"/></td>
					</tr>
					<tr>
						<td>상품수량</td>
						<td><input type="text" class="form-control form-control-sm" id="pQty" name="pQty"/></td>
					</tr>
					<tr>
						<td>상품가격</td>
					...
					<tr>
						<td>상품사양</td>
						<td>
							<select class="form-select form-select-sm" id="pSpec" name="pSpec">
